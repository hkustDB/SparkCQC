...
set output "output/figure/parallel_processing/q1_epinions.png"
# io, sparkcqc, sparksql, postgresql
plot "output/result/parallel_q1_epinions/io.dat" using 1:($2/1000) title "I/O" ls 1 w lp, "output/result/parallel_q1_epinions/sparkcqc.dat" using 1:($2/1000) title "SparkCQC" ls 2 w lp, "output/result/parallel_q1_epinions/sparksql.dat" using 1:($2/1000) title "SparkSQL" ls 4 w lp, "output/result/parallel_q1_epinions/postgresql.dat" using 1:($2/1000) title "PostgreSQL" ls 5 w lp
