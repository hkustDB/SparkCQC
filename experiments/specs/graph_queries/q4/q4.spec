spec.experiment.name=q4
spec.tasks.count=12

# io common properties
task.io.classname=org.SparkCQC.Query4SparkCQC
task.io.cores.max=1
...
task.cqc.classname=org.SparkCQC.Query4SparkCQC
...
task.spark.classname=org.SparkCQC.Query4SparkSQL
...
task4.postgresql.query=specs/graph_queries/q4/q4_epinions_postgresql.sql
...
task12.postgresql.query=specs/graph_queries/q4/q4_wiki_postgresql.sql
