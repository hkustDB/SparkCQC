spec.experiment.name=q7
spec.tasks.count=4

# io common properties
task.io.classname=org.SparkCQC.Query7SparkCQC
task.io.cores.max=1
...
task.cqc.classname=org.SparkCQC.Query7SparkCQC
...
task.spark.classname=org.SparkCQC.Query7SparkSQL
...
task1.io.graph.name=trade.txt

task2.system.name=cqc
task2.cqc.graph.name=trade.txt

task3.system.name=spark
task3.spark.graph.name=trade.txt

task4.system.name=postgresql
task4.postgresql.query=specs/analytical_queries/q7/q7_postgresql.sql
