spec.experiment.name=q6
spec.tasks.count=4

# io common properties
task.io.classname=org.SparkCQC.Query6SparkCQC
task.io.cores.max=1
...
task.cqc.classname=org.SparkCQC.Query6SparkCQC
...
task.spark.classname=org.SparkCQC.Query6SparkSQL
