spec.experiment.name=selectivity_q2_bitcoin
spec.tasks.count=20
...
task.io.graph.name=bitcoin.txt
task.io.cores.max=1
...
task.cqc.graph.name=bitcoin.txt
...
task.spark.graph.name=bitcoin.txt
...
task4.postgresql.query=specs/selectivity/q2_bitcoin/q2_bitcoin_1000_postgresql.sql
...
task8.postgresql.query=specs/selectivity/q2_bitcoin/q2_bitcoin_100_postgresql.sql
...
task12.postgresql.query=specs/selectivity/q2_bitcoin/q2_bitcoin_50_postgresql.sql
...
task16.postgresql.query=specs/selectivity/q2_bitcoin/q2_bitcoin_10_postgresql.sql
...
task20.postgresql.query=specs/selectivity/q2_bitcoin/q2_bitcoin_0_postgresql.sql
