spec.experiment.name=parallel_q2_bitcoin
spec.tasks.count=20
...
task.io.graph.name=bitcoin-txt-prepared
task.io.k.value=0
...
task.cqc.graph.name=bitcoin-txt-prepared
task.cqc.k.value=0
...
task.spark.graph.name=bitcoin-txt-prepared
task.spark.k.value=0

# postgresql common properties
task.postgresql.query=specs/parallel_processing/q2_bitcoin/q2_bitcoin_postgresql.sql
