 ...
 */
object Query3SparkCQCPlan3 extends App {
  val conf = new SparkConf()
  conf.setAppName("Query3SparkCQCPlan3")
  ...
  val cnt = C enumeration (g2, g2CoGroup, Array(0, 1, 2, 3), Array(0, 2), 3, 2, smaller(_,_), smaller(_,_), 4)
