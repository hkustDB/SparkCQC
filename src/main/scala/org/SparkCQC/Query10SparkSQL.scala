 ...
 */
object Query10SparkSQL {
    def main(args: Array[String]): Unit = {
        val conf = new SparkConf()
        conf.set("spark.serializer", "org.apache.spark.serializer.KryoSerializer")
        conf.setAppName("Query10SparkSQL")
        ...
        val g3c2 = spark.sql("select g3.src AS src, g3.dst AS dst, c2.cnt AS cnt " +
            "from Graph g3, countDF c2 where g3.dst = c2.src ")
        g3c2.createOrReplaceTempView("G3C2")
        g3c2.persist()
        g3c2.count()

        val resultDF = spark.sql("select g3c2.src as a, g3c2.dst as b, count(*) " +
            "from G1C1 g1c1, Graph g2, G3C2 g3c2 " +
            "where g1c1.dst = g2.src and g2.dst = g3c2.src " +
            "and g1c1.cnt < g3c2.cnt group by g3c2.src, g3c2.dst")
